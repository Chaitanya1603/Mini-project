...
<?php
 if ($_SERVER['REQUEST_METHOD'] == 'GET' && isset($_GET['submit_module'])) {
  // code that checks for the 'submit_module' key
      $sql = "INSERT INTO registration.modules (course_id,module_name, id) VALUES ('" . $_GET['course_name'] . "','" . $_GET['module_name'] . "', '1')";
