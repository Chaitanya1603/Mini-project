	...
	<header id="header">
		...
		<div class="head-container">
			<div class="quote">
				...
				<h3>YugNirdharak is an innovative achievement-tracking web application designed for students, parents, and teachers. 

YugNirdharak provides a user-friendly interface that allows students to create and track their academic and non-academic achievements. Teachers can use the system to assign tasks, track student progress, and provide feedback.

In today's fast-paced and competitive academic environment, YugNirdharak offers a unique and effective solution for tracking and promoting achievements. YugNirdharak is the perfect tool for students, parents, and teachers who want to track achievements.
</h3>
			</div>
			<div class="svg-image">
...
<!-- Some Popular Subjects -->
	...
	<div class="course">
		...
		<div class="det"><a href="index.php"><img src="images/courses/book.png">MATH</a></div>
		<div class="det"><a href="index.php"><img src="images/courses/d1.png">Science</a></div>
		<div class="det"><a href="index.php#sample_papers"><img src="images/courses/paper.png">EVS</a></div>
		<div class="det"><a href="index.php"><img src="images/courses/d1.png">Daily Quiz</a></div>
		</div></center>
		<div class="cbox">
		<div class="det"><a href="index.php"><img src="images/courses/computer.png">Abacus</a></div>
		<div class="det"><a href="index.php#data"><img src="images/courses/data.png">English</a></div>
		<div class="det"><a href="index.php#algo"><img src="images/courses/algo.png">GK</a></div>
		<div class="det det-last"><a href="index.php#projects"><img src="images/courses/projects.png">Projects</a></div>
		</div>
	</div>
...
<!-- TEAM -->
	<div class="diffSection" id="team_section">
		...
		<div class="totalcard">
			<div class="card">
				<center><img src="images/creator/Aryan w.png"></center>
			...
			<div class="card">
				<center><img src="images/creator/Chaitanya.png"></center>
			...
			<div class="card">
				<center><img src="images/creator/Rishika.png"></center>
			...
			<div class="card">
				<center><img src="images/creator/Tushar.png"></center>
...
<!-- SERVICES -->
	<div class="service-swipe">
		...
		<a href="index.php"><div class="s-card"><img src="images/icon/computer-courses.png"><p>​Student tracking system to support continuous learning. Improves education’s quality assurance</p></div></a>
		<a href="index.php"><div class="s-card"><img src="images/icon/brainbooster.png"><p>​Access to class-wise student enrolment.Individual student lookup via the web.</p></div></a>
		...
		<a href="index.php"><div class="s-card"><img src="images/icon/papers.jpg"><p>It includes various methods such as tests, exams, assignments, projects, portfolios, classroom participation, and self-assessment.</p></div></a>
		...
		<a href="#conction"><div class="s-card"><img src="images/icon/discussion.png"><p>​These services may include academic advising, tutoring, counseling, career services</p></div></a>
	</div>
