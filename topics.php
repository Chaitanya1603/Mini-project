...
if (isset($_GET['submit_topic'])) {
    $sql = "INSERT INTO registration.topics (course_id,module_id,topic_name,topic_description,id) VALUES ('1','1','" . $_GET['topic_name'] . "','" . $_GET['topic_description'] . "','1')";
                  ...
                  <tbody>
                    <?php
                      ...
                      while ($row = mysqli_fetch_array($run)) {
                        ...
                        $module_id = isset($row['module_id']) ? $row['module_id'] : null;
