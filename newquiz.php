...
if (isset($_POST['page']) && $_POST['page'] == "upload_file") {

}
else if (isset($_GET['page']) && $_GET['page'] == "create_assessment" && isset($_GET['module'])) {
        ...
        <div class="row">
          ...
          <div class="col-md-9">
             ...
             if(isset($_GET['module'])) {
              ...
              ?>
            <h1><i class="fa fa-graduation-cap" aria-hidden="true"></i> 
            <?php echo $_GET['assessment_name'] ?>
             <br><small>
             <?php 
if (isset($_GET['assessment_date'])) {
    $b = $_GET['assessment_date'];
    echo $b;
}
?>
